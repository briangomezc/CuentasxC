...
@FacesConverter(value = "tipodocumentosConverter")
public class TipodocumentosConverter implements Converter {

    private TipodocumentosFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Tipodocumentos) {
            Tipodocumentos o = (Tipodocumentos) object;
    ...
    private TipodocumentosFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(TipodocumentosFacade.class).get();
